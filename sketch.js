...
function draw() {
  ...
  if (d < 100 || d1 < 100 || d2 < 100) {
    cursor(HAND);
  } else if (mouseX > 0 && mouseX < width && mouseY > 0 && mouseY < width/15){
    cursor(HAND);
  }else {
    cursor(ARROW);
  }
...
function mousePressed() {
  ...
  if (d1 < 100) {
    location.reload();
    location.href = "https://samesamebutdifferent-04.netlify.app";
  }

  if (d2 < 100) {
    location.reload();
    location.href = "https://samesamebutdifferent-06.netlify.app";
  }
